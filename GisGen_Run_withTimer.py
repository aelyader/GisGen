...
from PySide6.QtWidgets import (QApplication, QWidget, QVBoxLayout, QHBoxLayout,
                               ...
                               QProgressBar)
from PySide6.QtCore import QThread, Signal, QTime, QTimer
import requests
...
class MainApplication(QWidget):
    ...
    def createSubtitleLayout(self):
        ...
        # Create QFont object with desired font properties
        font = QFont()
        font.setPointSize(11)  # Set font size to 12 points, adjust as needed
        # Apply the font to the button
        info_button.setFont(font)
        info_button.clicked.connect(self.show_instructions)  # Connect the button to the method
